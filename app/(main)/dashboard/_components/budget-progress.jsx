      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            {isEditing ? (
              <div className="flex items-center mt-2 rounded gap-2">
                <Input
                  type="number"
                  value={newBudget}
              ...
              <>
                <CardDescription className="mt-2 text-md font-normal">
                  {initialBudget
      ...
      <CardContent>
        {initialBudget && (
          <div className="space-y-2">
            ...
            />
            <p className="font-medium mr-4 text-muted-foreground text-right">
