    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 rounded">
        ...
        <div className="flex gap-2">
          ...
          >
            <SelectTrigger className="w-[130px] rounded bg-white">
              <SelectValue placeholder="All Types" />
            </SelectTrigger>
            <SelectContent className="bg-white">
              <SelectItem value="INCOME" className="border-b cursor-pointer">Income</SelectItem>
          ...
          >
            <SelectTrigger className="w-[130px] rounded">
              <SelectValue placeholder="All Transactions" />
            </SelectTrigger>
            <SelectContent className="bg-white ">
              <SelectItem value="recurring" className="border-b cursor-pointer">Recurring Only</SelectItem>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-white">
                        <DropdownMenuItem className="border-b cursor-pointer"
                          onClick={() =>
                            router.push(
