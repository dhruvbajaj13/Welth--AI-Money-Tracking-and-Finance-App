    ...
    <div className="mt-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {howItWorksData.map((step, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-[20px] font-semibold mb-4">{step.title}</h3>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 font-medium mb-8 max-w-2xl mx-auto">
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-blue-50 animate-bounce rounded"
            >
              Start Free Trial
            </Button>
          </Link>
